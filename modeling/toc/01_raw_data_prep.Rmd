...
end_date <- "2025-12-05 23:59:59"    # MST
...
This will/should become a function in the future 
(ie water_chem <- `pull_upper_clp_chem_data(zenodo_data_version, save_folder_dir, fc_data_path)`)
